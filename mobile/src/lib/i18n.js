...
export const translations = {
  ...
  en: {
    ...
    subscribeToPro: 'Subscribe to Memor.ia Pro',
    haveActivationCode: 'I have an activation code',
    restorePurchases: 'Restore purchases',
    activatedByCode: 'Activated by code',
    subscriptionActive: 'Active subscription',
    subscriptionSuccess: 'Subscription activated!',
    welcomeToPro: 'Welcome to Memor.ia Pro!',
    ...
    invalidCodeFormat: 'Invalid format',
    useCodeFormat: 'Use the format XXXX-XXXX-XXXX',
    activationFailed: 'Activation failed',
    enterActivationCodeDescription: 'Enter the activation code provided by the influencer or partner.',
    trialExpired: 'Trial Expired',
    trialExpiredMessage: 'Your 3-day trial period has ended. Subscribe to continue using all features.',
    autoCloudBackup: 'Automatic cloud backup active',
  },
  ...
  pt: {
    ...
    subscribeToPro: 'Assinar Memor.ia Pro',
    haveActivationCode: 'Tenho código de ativação',
    restorePurchases: 'Restaurar compras',
    activatedByCode: 'Ativado por código',
    subscriptionActive: 'Subscrição ativa',
    subscriptionSuccess: 'Subscrição ativada!',
    welcomeToPro: 'Bem-vindo ao Memor.ia Pro!',
    subscriptionError: 'Erro na subscrição',
    tryAgainLater: 'Tenta novamente mais tarde',
    purchasesRestored: 'Compras restauradas!',
    noSubscriptionFound: 'Sem subscrição encontrada',
    noPreviousPurchases: 'Não encontrámos compras anteriores',
    restoreError: 'Erro ao restaurar',
    invalidCodeFormat: 'Formato inválido',
    useCodeFormat: 'Usa o formato XXXX-XXXX-XXXX',
    activationFailed: 'Falha na ativação',
    enterActivationCodeDescription: 'Introduz o código de ativação fornecido pelo influenciador ou parceiro.',
    trialExpired: 'Período de Teste Expirado',
    trialExpiredMessage: 'O teu período de teste de 3 dias terminou. Subscreve para continuar a usar todas as funcionalidades.',
    autoCloudBackup: 'Backup automático na cloud ativo',
  },
  ...
  es: {
    ...
    pasted: 'Pegado del Clipboard',
    clipboardEmpty: 'Clipboard vacío',
    all: 'Todo',
    done: 'Hecho',
    confirm: 'Confirmar',
    loading: 'Cargando...',
    ...
    // Premium & Subscription
    subscribeToPro: 'Suscribirse a Memor.ia Pro',
    haveActivationCode: 'Tengo código de activación',
    restorePurchases: 'Restaurar compras',
    activatedByCode: 'Activado por código',
    subscriptionActive: 'Suscripción activa',
    subscriptionSuccess: '¡Suscripción activada!',
    welcomeToPro: '¡Bienvenido a Memor.ia Pro!',
    ...
    noPreviousPurchases: 'No encontramos compras anteriores',
    restoreError: 'Error al restaurar',
    invalidCodeFormat: 'Formato inválido',
    useCodeFormat: 'Usa el formato XXXX-XXXX-XXXX',
    activationFailed: 'Fallo en la activación',
    enterActivationCodeDescription: 'Introduce el código de activación proporcionado por el influencer o socio.',
    trialExpired: 'Prueba Expirada',
    trialExpiredMessage: 'Tu período de prueba de 3 días ha terminado. Suscríbete para seguir usando todas las funciones.',
    autoCloudBackup: 'Backup automático en la nube activo',
  },
  ...
  fr: {
    ...
    // Premium & Subscription
    subscribeToPro: 'S\'abonner à Memor.ia Pro',
    haveActivationCode: 'J\'ai un code d\'activation',
    restorePurchases: 'Restaurer les achats',
    activatedByCode: 'Activé par code',
    subscriptionActive: 'Abonnement actif',
    subscriptionSuccess: 'Abonnement activé !',
    welcomeToPro: 'Bienvenue dans Memor.ia Pro !',
    ...
    invalidCodeFormat: 'Format invalide',
    useCodeFormat: 'Utilisez le format XXXX-XXXX-XXXX',
    activationFailed: 'Échec de l\'activation',
    enterActivationCodeDescription: 'Entrez le code d\'activation fourni par l\'influenceur ou le partenaire.',
    trialExpired: 'Essai Expiré',
    trialExpiredMessage: 'Votre période d\'essai de 3 jours est terminée. Abonnez-vous pour continuer à utiliser toutes les fonctionnalités.',
    autoCloudBackup: 'Sauvegarde cloud automatique active',
  },
  ...
  de: {
    ...
    pasted: 'Aus Clipboard eingefügt',
    clipboardEmpty: 'Clipboard leer',
    all: 'Alle',
    done: 'Fertig',
    confirm: 'Bestätigen',
    ...
    // Premium & Subscription
    subscribeToPro: 'Memor.ia Pro abonnieren',
    haveActivationCode: 'Ich habe einen Aktivierungscode',
    restorePurchases: 'Käufe wiederherstellen',
    activatedByCode: 'Per Code aktiviert',
    subscriptionActive: 'Abonnement aktiv',
    subscriptionSuccess: 'Abonnement aktiviert!',
    welcomeToPro: 'Willkommen bei Memor.ia Pro!',
    ...
    invalidCodeFormat: 'Ungültiges Format',
    useCodeFormat: 'Verwende das Format XXXX-XXXX-XXXX',
    activationFailed: 'Aktivierung fehlgeschlagen',
    enterActivationCodeDescription: 'Gib den Aktivierungscode ein, der vom Influencer oder Partner bereitgestellt wurde.',
    trialExpired: 'Testversion Abgelaufen',
    trialExpiredMessage: 'Deine 3-tägige Testphase ist beendet. Abonniere, um alle Funktionen weiter zu nutzen.',
    autoCloudBackup: 'Automatische Cloud-Sicherung aktiv',
  },
  ...
  it: {
    ...
    pasted: 'Incollato dal Clipboard',
    clipboardEmpty: 'Clipboard vuoto',
    all: 'Tutto',
    done: 'Fatto',
    confirm: 'Conferma',
    loading: 'Caricamento...',
    ...
    // Premium & Subscription
    subscribeToPro: 'Abbonati a Memor.ia Pro',
    haveActivationCode: 'Ho un codice di attivazione',
    restorePurchases: 'Ripristina acquisti',
    activatedByCode: 'Attivato con codice',
    subscriptionActive: 'Abbonamento attivo',
    subscriptionSuccess: 'Abbonamento attivato!',
    welcomeToPro: 'Benvenuto in Memor.ia Pro!',
    subscriptionError: 'Errore abbonamento',
    ...
    invalidCodeFormat: 'Formato non valido',
    useCodeFormat: 'Usa il formato XXXX-XXXX-XXXX',
    activationFailed: 'Attivazione fallita',
    enterActivationCodeDescription: 'Inserisci il codice di attivazione fornito dall\'influencer o dal partner.',
    trialExpired: 'Prova Scaduta',
    trialExpiredMessage: 'Il tuo periodo di prova di 3 giorni è terminato. Abbonati per continuare a usare tutte le funzionalità.',
    autoCloudBackup: 'Backup cloud automatico attivo',
  },
};
