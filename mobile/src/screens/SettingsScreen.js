...
import { View, Text, ScrollView, TouchableOpacity, TextInput, StyleSheet, Modal, Switch, Platform, Linking, Alert, Image } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  premiumIcon: { width: 60, height: 60, borderRadius: 30, backgroundColor: 'rgba(255, 255, 255, 0.1)', justifyContent: 'center', alignItems: 'center', overflow: 'hidden' },
  premiumLogo: { width: 50, height: 50, borderRadius: 25 },
  ...
  logoCard: { alignItems: 'center', justifyContent: 'center', margin: 16, padding: 0, borderRadius: 20, backgroundColor: '#1C1C1E', overflow: 'hidden' },
  logoImage: { width: '100%', height: 120, borderRadius: 20 },
