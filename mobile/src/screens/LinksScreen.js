...
import { View, Text, TouchableOpacity, TextInput, StyleSheet, Image, Linking, Alert, RefreshControl, Modal, ScrollView, Switch, FlatList, Keyboard, TouchableWithoutFeedback, KeyboardAvoidingView, Platform, useWindowDimensions } from 'react-native';
...
export default function LinksScreen({ language, userId, refreshKey }) {
  ...
  return (
    ...
    <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
      ...
      <View style={[styles.container, { paddingHorizontal: isTablet && isLandscape ? 32 : 0 }]}>
        ...
        <View style={[styles.addContainer, isTablet && styles.addContainerTablet]}>
        ...
        <View style={[styles.folderSection, isTablet && styles.folderSectionTablet]}>
...
const styles = StyleSheet.create({
  ...
  searchContainerTablet: { marginHorizontal: 24 },
  ...
  addContainerTablet: { marginHorizontal: 24 },
  ...
  folderSectionTablet: { marginHorizontal: 24 },
